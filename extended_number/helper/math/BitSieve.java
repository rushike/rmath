...
class BitSieve {
     ...
     * sieve.
     */
    public static BitSieve smallSieve = new BitSieve();
     ...
     */
    public static int unitIndex(int bitIndex) {
        return bitIndex >>> 6;
    }
     ...
     */
    public static long bit(int bitIndex) {
     ...
     */
    public int sieveSearch(int limit, int start) {
        if (start >= limit)
            return -1;
     ...
     */
    public void sieveSingle(int limit, int start, int step) {
        while(start < limit) {
            set(start);
            start += step;
        }

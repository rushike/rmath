...
public class BigInteger extends Number implements Comparable<BigInteger> {
     ...
     */
    public static final  int PRIME_SEARCH_BIT_LENGTH_LIMIT = 500000000;
     ...
     * experimentally to work well.
     */
    public static final int KARATSUBA_SQUARE_THRESHOLD = 128;
     ...
     * experimentally to work well.
     */
    public static final int TOOM_COOK_SQUARE_THRESHOLD = 216;
     ...
     */
    public static final int SCHOENHAGE_BASE_CONVERSION_THRESHOLD = 20;
     ...
     * use the intrinsic.
     */
    public static final int MONTGOMERY_INTRINSIC_THRESHOLD = 512;
    ...
    /**
     * This public constructor translates an int array containing the
    ...
    public int parseInt(char[] source, int start, int end) {
    ...
    public static long bitsPerDigit[] = { 0, 0,
    ...
    public static byte[] randomBits(int numBits, Random rnd) {
        if (numBits < 0)
    ...
    public static final int SMALL_PRIME_THRESHOLD = 95;
     ...
     */
    public static BigInteger smallPrime(int bitLength, int certainty, Random rnd) {
    ...
    public static final BigInteger SMALL_PRIME_PRODUCT
     ...
     * test.
     */
    public static BigInteger largePrime(int bitLength, int certainty, Random rnd) {
        BigInteger p;
    ...
    */
    ...
    public static int getPrimeSearchLen(int bitLength) {
    ...
    public static BigInteger lucasLehmerSequence(int z, BigInteger k, BigInteger n) {
    ...
    /**
     * This public constructor is for internal use and assumes that its
     * arguments are correct.
     */
    public BigInteger(byte[] magnitude, int signum) {
        this.signum = (magnitude.length == 0 ? 0 : signum);
        this.mag = stripLeadingZeroBytes(magnitude);
        if (mag.length >= MAX_MAG_LENGTH) {
            checkRange();
     ...
     */
    public final static int MAX_CONSTANT = 16;
    public static BigInteger posConst[] = new BigInteger[MAX_CONSTANT+1];
    public static BigInteger negConst[] = new BigInteger[MAX_CONSTANT+1];
     ...
     */
    public static volatile BigInteger[][] powerCache;

    /** The cache of logarithms of radices for base conversion. */
    public static final double[] logCache;
    ...
    /**
     * Package public methods used by BigDecimal code to add a BigInteger
     ...
     * non-negative
     */
    public static int[] add(int[] x, long val) {
        int[] y;
        long sum = 0;
        int xIndex = x.length;
        int[] result;
    ...
    public static int[] subtract(long val, int[] little) {
        int highWord = (int)(val >>> 32);
        if (highWord == 0) {
     ...
     * assumes val &gt;= 0
     */
    public static int[] subtract(int[] big, long val) {
        int highWord = (int)(val >>> 32);
    ...
    public static BigInteger multiplyByInt(int[] x, int y, int sign) {
    ...
    /**
     * Package public methods used by BigDecimal code to multiply a BigInteger
     ...
     *
     */
    public static BigInteger multiplyToomCook3(BigInteger a, BigInteger b) {
     ...
     */
    public BigInteger getLower(int n) {
        int len = mag.length;
     ...
     * Karatsuba squaring.
     */
    public BigInteger getUpper(int n) {
        int len = mag.length;
     ...
     */
    public static final int[] squareToLen(int[] x, int len, int[] z) {
         int zlen = len << 1;
      ...
      */
     public static void implSquareToLenChecks(int[] x, int len, int[] z, int zlen) throws RuntimeException {
         if (len < 1) {
      ...
      */
     public static final int[] implSquareToLen(int[] x, int len, int[] z, int zlen) {
        /*
     ...
     */
    public BigInteger divideKnuth(BigInteger val) {
    ...
    /** Long division */
    public BigInteger[] divideAndRemainderKnuth(BigInteger val) {
    ...
    /** Long division */
    public BigInteger remainderKnuth(BigInteger val) {
        MutableBigInteger q = new MutableBigInteger(),
                          a = new MutableBigInteger(this.mag),
                          b = new MutableBigInteger(val.mag);
     ...
     * @return {@code this / val}
     */
    public BigInteger divideBurnikelZiegler(BigInteger val) {
     ...
     * @return {@code this % val}
     */
    public BigInteger remainderBurnikelZiegler(BigInteger val) {
     ...
     */
    public BigInteger[] divideAndRemainderBurnikelZiegler(BigInteger val) {
        MutableBigInteger q = new MutableBigInteger();
    ...
    /**
     * Package public method to return bit length for an integer.
     */
     ...
     */
    public static int bitLength(int[] val, int len) {
        if (len == 0)
            return 0;
    ...
    public static int[] montgomeryMultiply(int[] a, int[] b, int[] n, int len, long inv,
                                            int[] product) {
    ...
    public static int[] montgomerySquare(int[] a, int[] n, int len, long inv,
                                          int[] product) {
    ...
    public static void implMontgomeryMultiplyChecks
    ...
    // sufficiently large.
    public static int[] materialize(int[] z, int len) {
    ...
    // intrinsics.
    public static int[] implMontgomeryMultiply(int[] a, int[] b, int[] n, int len,
                                         long inv, int[] product) {
        product = multiplyToLen(a, len, b, len, product);
        return montReduce(product, n, len, (int)inv);
    }
    public static int[] implMontgomerySquare(int[] a, int[] n, int len,
                                       long inv, int[] product) {
        product = squareToLen(a, len, product);
        return montReduce(product, n, len, (int)inv);
    }
     ...
     */
    public static int[] montReduce(int[] n, int[] mod, int mlen, int inv) {
        int c=0;
        int len = mlen;
        int offset=0;
     ...
     */
    public static int subN(int[] a, int[] b, int len) {
        long sum = 0;
     ...
     * Parameters validation.
     */
    public static void implMulAddCheck(int[] out, int[] in, int offset, int len, int k) {
        if (len > in.length) {
     ...
     */
    public BigInteger modPow2(BigInteger exponent, int p) {
        /*
     ...
     * @return {@code this >> n}
     */
    public BigInteger shiftRightImpl(int n) {
        int nInts = n >>> 5;
        int nBits = n & 0x1f;
        int magLen = mag.length;
        int newMag[] = null;
    ...
    public String smallToString(int radix) {
        if (signum == 0) {
            return "0";
        }
     ...
     */
    public static void toString(BigInteger u, StringBuilder sb, int radix,
                                 int digits) {
     ...
     * {@code Future}.
     */
    public static BigInteger getRadixConversionCache(int radix, int exponent) {
    ...
    public static String zeros[] = new String[64];
    static {
        zeros[63] =
     ...
     * Returns a copy of the input array stripped of any leading zero bytes.
     */
    public static int[] stripLeadingZeroBytes(byte a[]) {
     ...
     */
    public static int[] makePositive(byte a[]) {
        int keep, k;
        int byteLength = a.length;
     ...
     * used.
     */
    public static int digitsPerLong[] = {0, 0,
        62, 39, 31, 27, 24, 22, 20, 19, 18, 18, 17, 17, 16, 16, 15, 15, 15, 14,
        14, 14, 14, 13, 13, 13, 13, 13, 13, 12, 12, 12, 12, 12, 12, 12, 12};

    public static BigInteger longRadix[] = {null, null,
     ...
     */
    public static int digitsPerInt[] = {0, 0, 30, 19, 15, 13, 11,
        11, 10, 9, 9, 8, 8, 8, 8, 7, 7, 7, 7, 7, 7, 7, 6, 6, 6, 6,
        6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 5};

    public static int intRadix[] = {0, 0,
    ...
    public static final long serialVersionUID = -8287574255936472291L;
    ...
    public static class UnsafeHolder {
        ...
        public static final long signumOffset;
        public static final long magOffset;
        static {
            try {

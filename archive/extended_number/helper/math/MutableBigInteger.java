...
import static extended_number.helper.math.BigDecimal.INFLATED;
...
class MutableBigInteger {
     ...
     */
    public int compareShifted(MutableBigInteger b, int ints) {
        int blen = b.intLen;
     ...
     */
    public int divadd(int[] a, int[] result, int offset) {
        long carry = 0;
     ...
     */
    public int mulsub(int[] q, int[] a, int x, int len, int offset) {
     ...
     */
    public int mulsubBorrow(int[] q, int[] a, int x, int len, int offset) {
        long xLong = x & LONG_MASK;
        long carry = 0;
        offset += len;
        for (int j=len-1; j >= 0; j--) {
     ...
     */
    public final void primitiveRightShift(int n) {
        int[] val = value;
        int n2 = 32 - n;
     ...
     * Assumes that intLen > 0, n > 0 for speed
     */
    public final void primitiveLeftShift(int n) {
        int[] val = value;
        int n2 = 32 - n;
     ...
     */
    public int difference(MutableBigInteger b) {
        MutableBigInteger a = this;
        int sign = a.compare(b);
        if (sign == 0)
            return 0;
     ...
     * @return {@code this%b}
     */
    public MutableBigInteger divide2n1n(MutableBigInteger b, MutableBigInteger quotient) {
        int n = b.intLen;
     ...
     * @return {@code this%b}
     */
    public MutableBigInteger divide3n2n(MutableBigInteger b, MutableBigInteger quotient) {
     ...
     * @return
     */
    public MutableBigInteger getBlock(int index, int numBlocks, int blockLength) {
    ...
    public static void copyAndShift(int[] src, int srcFrom, int srcLen, int[] dst, int dstFrom, int shift) {
        int n2 = 32 - shift;
        int c=src[srcFrom];
     ...
     */
    public MutableBigInteger divideMagnitude(MutableBigInteger div,
     ...
     * the remainder object is returned.
     */
    public MutableBigInteger divideLongMagnitude(long ldivisor, MutableBigInteger quotient) {
     ...
     */
    public int divaddLong(int dh, int dl, int[] result, int offset) {
        long carry = 0;
     ...
     * dh is a high part of the divisor, dl is a low part
     */
    public int mulsubLong(int[] q, int dh, int dl, int x, int offset) {
        long xLong = x & LONG_MASK;
        offset += 2;
     ...
     */
    public boolean unsignedLongCompare(long one, long two) {
     ...
     */
    public MutableBigInteger binaryGCD(MutableBigInteger v) {
